...
#pragma endregion
    ...
    private: System::Void выполнитьToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
        ...
        if (comboBox1->SelectedIndex == 0 || comboBox1->SelectedIndex == 1 || comboBox1->SelectedIndex == 2)
        {
            ...
            if (correct_function(function1, 1)) // проверка, корректна ли введена функция
            ...
            if (user_data(start_digit1, end_digit1, step1, some_start_digit1, some_end_digit1, some_step1)) //проверка, корректно ли введены доп. условия 
                goto link; // в случае, если введена некорректно
        ...
        if (comboBox1->SelectedIndex == 1 || comboBox1->SelectedIndex == 2)
        {
            ...
            if (correct_function(function2, 2)) // проверка, корректна ли введена функция
                goto link; // в случае, если введена некорректно
            ...
            if (user_data(start_digit2, end_digit2, step2, some_start_digit2, some_end_digit2, some_step2)) // проверка, корректно ли введены доп. условия 
                goto link; // в случае, если введена некорректно
        ...
        if (comboBox1->SelectedIndex == 2)
        {
            ...
            if (correct_function(function3, 3)) // проверка, корректна ли введена функция
                goto link; // в случае, если введена некорректно
            ...
            if (user_data(start_digit3, end_digit3, step3, some_start_digit3, some_end_digit3, some_step3)) // проверка, корректно ли введены доп. условия 
                goto link; // в случае, если введена некорректно
